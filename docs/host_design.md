...
- "Set RTC Time" control: a date/time picker + button that sends `SET_TIME:YYYY-MM-DD,HH:MM:SS\n` over the serial connection, implementing the reserved GUI channel from `requirements_spec.md` §6.4 / `design.md` §3.5. This is additive to usmart, not a replacement.
